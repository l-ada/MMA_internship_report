...
The goal of the internship was to adapt the approach to fine-tuning from \cite{neuralscf}. This required ...
...
The algorithm for finding fixed point is projected gradient descent.
